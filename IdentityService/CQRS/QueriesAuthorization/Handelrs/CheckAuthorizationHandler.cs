...
namespace IdentityService.CQRS.QueriesAuthorization.Handelrs
{
    public class CheckAuthorizationHandler : IRequestHandler<CheckAuthorizationQuery, AuthorizationAudit>
    {
        ...
        public CheckAuthorizationHandler(IRolesRepository rolesRepository, IRolePermissionRepository rolePermissionRepository, IPermissionsRepository permissionRepository)
        {
