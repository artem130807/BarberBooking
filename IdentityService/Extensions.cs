...
namespace IdentityService
{
    public static class Extensions
    {
        ...
        public static void AddProducer<TMessage>(this IServiceCollection services, IConfigurationSection section)
        {
            ...
            services.AddSingleton<IKafkaProducerService<TMessage>, KafkaProducerService<TMessage>>();
        }
        public static void AddProducerLog<TMessage>(this IServiceCollection services, IConfigurationSection section) where TMessage: ApprovalEventBase
        {
            services.Configure<KafkaSettingsLog>(section);
            services.AddSingleton<IKafkaProducerLogService<TMessage>, KafkaProducerLogService<TMessage>>();
        }
        ...
        public static IServiceCollection AddConsumer<TMessage, THandler>(this IServiceCollection services, IConfigurationSection section) where THandler: class, IMessageHandler<TMessage>
        {
            services.Configure<KafkaSettingsConsumer>(section);
            services.AddScoped<IMessageHandler<TMessage>, THandler>();
            services.AddHostedService<KafkaConsumerService<TMessage>>();
            return services;
        }
