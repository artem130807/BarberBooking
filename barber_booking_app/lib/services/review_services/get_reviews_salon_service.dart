...
Future<List<GetReviewsSalonResponse>?> getReviewsSalon(String? salonId, PageParams pageParams) async{
     try {

        final url = Uri.parse('$baseUrl/api/Review/GetReviewsBySalonId/$salonId').replace(
          queryParameters: {
