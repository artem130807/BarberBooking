...
final GetAppointmentsByClientService _getAppointmentsByClientService = GetAppointmentsByClientService();

List<GetAppointmentsByClientResponse>? _list;
List<GetAppointmentsByClientResponse>? get list => _list;

Future<bool?> getAppointments(String? token) async{
 startLoading();
    try{
      final response = await _getAppointmentsByClientService.getAppointments(token);
